...
class StudentApplicationsControllerTest < ActionController::TestCase
  ...
  test "should show student_application" do
    ...
    test "should update student_application" do
      sign_in students(:user1)
      patch :update, id: @student_application, student_application: { student_id: @student_application.student_id, email_id: @student_application.email_id, gpa: @student_application.gpa, name: @student_application.name, phone: @student_application.phone, address: @student_application.address, resume_file_name: 'resume.pdf', sop_file_name: 'sop.pdf', lor_file_name: 'lor.pdf' }
      assert_redirected_to student_application_path(assigns(:student_application))
    end
